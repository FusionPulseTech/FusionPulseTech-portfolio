        ...
        <div className="container px-5 py-24 mx-auto">
          ...
          <div className="lg:w-1/2 md:w-2/3 mx-auto">
            <div className="flex flex-wrap -m-2">
              ...
              <div className="p-2 w-full">
                <button className="flex mx-auto text-white bg-[#684DF4] border-0 py-2 px-8 focus:outline-none hover:bg-gray-900 transition-colors duration-300 rounded text-lg">
                  Send
                </button>
              </div>
            </div>
